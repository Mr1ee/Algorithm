 ...
 * ，这个比较好理解的，因为Max(LMax1, LMax2)肯定是左边k个元素的最大值，因为合并后的数组是有序，
 * 第k个元素肯定前面k个元素中最大的那个。
 * <p>
 * 那么如果 LMax1>RMin2，说明数组1的左边元素太大（多），我们把C1减小，C2=k-C1也就相应的增大。
 ...
 * [1 / 4 7 9]
 * <p>
 * 这时LMax1 =3, RMin1 = 5, LMax2=1, RMin2=4, 满足 LMax1 < RMin2 且 LMax2 < RMin1 ,
 * 所以第3个元素为Max(LMax1,LMax2) = 3
 */
public class Problem4Java {
